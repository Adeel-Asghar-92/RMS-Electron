...
const AddCategory = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col justify-between bg-[#1B1B1B] rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-1 gap-4">
              ...
              <div className="flex items-end">
                <button
                  ...
                  className="w-full bg-[#FD4960] px-[31px] py-[14px] rounded-full"
                >
                  Add Sub-Category
                </button>
              </div>
        ...
        <div className="col-span-1 bg-[#1B1B1B] rounded-lg p-6 h-max">
          ...
          {/* <div className="flex flex-col items-center gap-4">
            {previewImage ? (
              ...
              <div className="px-3 py-8 border-1 border-dashed border-[#474C59] rounded-2xl flex flex-col items-center justify-center gap-4 w-full">
            ...
            <label
              ...
              className="w-full bg-[#FD4960] px-[31px] py-[14px] rounded-full text-center cursor-pointer"
            >
            ...
            {previewImage ? (
              ...
              >
                ...
                <p className="text-sm text-center">
                  ...
                  <br />
                  <span
                    className="text-[#FD4960] cursor-pointer"
                    onClick={() =>
