...
import Title from "../../user/auth/title";
...
export default function AdminLogin() {
  ...
  return (
    <>
      <Navbar />
      <div className=" bg-black text-white font-[poppins] mt-[110px]">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full h-[56px] pl-[16px] pr-[40px] rounded-2xl border-1 border-[#474C59] bg-transparent  placeholder:text-base placeholder:font-medium placeholder:text-[#474C59] focus:outline-none text-[16px] font-[500] leading-[24px] text-[#fff]"
